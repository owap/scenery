...
var BeanstalkSourcebundle = require('../properties/BeanstalkSourcebundle.js');

var propertyMap = {'ApplicationName': {'list': false, 'type': 'string'},
 'Description': {'list': false, 'type': 'string'},
 'SourceBundle': {'list': false, 'type': BeanstalkSourcebundle}};

var Class = function (id) {
    return Resource.call(this, id, 'AWS::ElasticBeanstalk::ApplicationVersion', {});
};
