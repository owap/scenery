...
var DBSecurityGroupIngres = require('../properties/DBSecurityGroupIngres.js');
var aws_properties_resource_tags = require('../properties/aws_properties_resource_tags.js');

var propertyMap = {'DBSecurityGroupIngress': {'list': true, 'type': DBSecurityGroupIngres},
 'EC2VpcId': {'list': false, 'type': 'string'},
 'GroupDescription': {'list': false, 'type': 'string'},
 'Tags': {'list': true, 'type': aws_properties_resource_tags}};

var Class = function (id) {
    return Resource.call(this, id, 'AWS::RDS::DBSecurityGroup', {});
};
