...
var propertyMap = {'DestinationCidrBlock': {'list': false, 'type': 'string'},
 'GatewayId': {'list': false, 'type': 'string'},
 'InstanceId': {'list': false, 'type': 'string'},
 'NetworkInterfaceId': {'list': false, 'type': 'string'},
 'RouteTableId': {'list': false, 'type': 'string'}};

var Class = function (id) {
    return Resource.call(this, id, 'Route', {});
};
