...
var propertyMap = {'CidrBlock': {'list': false, 'type': 'string'},
 'EnableDnsHostnames': {'list': false, 'type': 'boolean'},
 'EnableDnsSupport': {'list': false, 'type': 'boolean'},
 'InstanceTenancy': {'list': false, 'type': 'string'},
 'Tags': {'list': false, 'type': aws_properties_resource_tags}};

var Class = function (id) {
    return Resource.call(this, id, 'AWS::EC2::VPC', {});
};
