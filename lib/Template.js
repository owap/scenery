...
Template.prototype.vpc = function (id, description) {
    return this.addResource(new VPC(id, description));
};

Template.prototype.vpcGatewayAttachent = function (id, description) {
