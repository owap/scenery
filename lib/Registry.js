...
function Registry() {
    ...
    // Build a map of AWS Types to Spatula Classes
    this.awsClassMap = {};
    var classesToIgnore = [
        'Module',       // Spatula class not registered with AWS
        'Registry',     // This class; avoid recursive requires
        'Resource',     // Spatula class not registered with AWS
        'Template',     // Registry used in this class; avoid recursive requires
        'Validator'     // Spatula class not registered with AWS
    ];
