...
var propertyMap = {'ParameterName': {'list': false, 'type': 'String'},
 'ParameterValue': {'list': false, 'type': 'String'}};

var Class = function (id) {
    return Resource.call(this, id, 'aws_property_redshift_clusterparametergroup_parameter', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
