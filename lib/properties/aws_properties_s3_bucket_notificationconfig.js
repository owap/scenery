...
var TopicConfiguration = require('../properties/TopicConfiguration.js');

var propertyMap = {'TopicConfigurations': {'list': false, 'type': TopicConfiguration}};

var Class = function (id) {
    return Resource.call(this, id, 'aws_properties_s3_bucket_notificationconfig', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
