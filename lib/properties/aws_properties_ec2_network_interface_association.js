...
var propertyMap = {'AttachmentID': {'list': false, 'type': 'String'},
 'InstanceID': {'list': false, 'type': 'String'},
 'IpOwnerId': {'list': false, 'type': 'String'},
 'PublicIp': {'list': false, 'type': 'String'}};

var Class = function (id) {
    return Resource.call(this, id, 'aws_properties_ec2_network_interface_association', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
