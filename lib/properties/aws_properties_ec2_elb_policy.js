...
var propertyMap = {'Attributes': {'list': false, 'type': 'object'},
 'InstancePorts': {'list': true, 'type': 'string'},
 'LoadBalancerPorts': {'list': true, 'type': 'string'},
 'PolicyName': {'list': false, 'type': 'string'},
 'PolicyType': {'list': false, 'type': 'string'}};

var Class = function (id) {
    return Resource.call(this, id, 'aws_properties_ec2_elb_policy', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
