...
var GeoRestriction = require('../properties/GeoRestriction.js');

var propertyMap = {'GeoRestriction': {'list': false, 'type': GeoRestriction}};

var Class = function (id) {
    return Resource.call(this, id, 'Restriction', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
