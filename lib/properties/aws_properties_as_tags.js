...
var propertyMap = {'Key': {'list': false, 'type': 'String'},
 'PropagateAtLaunch': {'list': false, 'type': 'Boolean'},
 'Value': {'list': false, 'type': 'String'}};

var Class = function (id) {
    return Resource.call(this, id, 'aws_properties_as_tags', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
