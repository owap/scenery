...
var propertyMap = {'Password': {'list': false, 'type': 'string'},
 'Revision': {'list': false, 'type': 'string'},
 'SshKey': {'list': false, 'type': 'string'},
 'Type': {'list': false, 'type': 'string'},
 'Url': {'list': false, 'type': 'string'},
 'Username': {'list': false, 'type': 'string'}};

var Class = function (id) {
    return AWSClass.call(this, id, 'OpsworksStackSource', {});
};
