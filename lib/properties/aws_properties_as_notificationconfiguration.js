...
var propertyMap = {'NotificationTypes': {'list': true, 'type': 'String'},
 'TopicARN': {'list': false, 'type': 'String'}};

var Class = function (id) {
    return Resource.call(this, id, 'aws_properties_as_notificationconfiguration', {});
};
// TODO: Create a Property base class so properties don't extend Resource!
