...
var Ec2PortRange = require('../properties/Ec2PortRange.js');
var Ec2Icmp = require('../properties/Ec2Icmp.js');

var propertyMap = {'CidrBlock': {'list': false, 'type': 'string'},
 'Egress': {'list': false, 'type': 'boolean'},
 'Icmp': {'list': false, 'type': Ec2Icmp},
 'NetworkAclId': {'list': false, 'type': 'string'},
 'PortRange': {'list': false, 'type': Ec2PortRange},
