...
var OpsworksAppSslconfiguration = require('../properties/OpsworksAppSslconfiguration.js');

var propertyMap = {'AppSource': {'list': false, 'type': OpsworksStackSource},
 'Attributes': {'list': false, 'type': 'object'},
 ...
 'SslConfiguration': {'list': false, 'type': OpsworksAppSslconfiguration},
 'StackId': {'list': false, 'type': 'string'},
 'Type': {'list': false, 'type': 'string'}};

var Class = function (id) {
    return Resource.call(this, id, 'AWS::OpsWorks::App', {});
};
