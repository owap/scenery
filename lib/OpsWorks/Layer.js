...
var OpsworksLayerRecipe = require('../properties/OpsworksLayerRecipe.js');
var OpsworksLayerVolumeconfig = require('../properties/OpsworksLayerVolumeconfig.js');
...
var propertyMap = {'Attributes': {'list': false, 'type': 'object'},
 ...
 'CustomRecipes': {'list': false, 'type': OpsworksLayerRecipe},
 ...
 'VolumeConfigurations': {'list': false, 'type': OpsworksLayerVolumeconfig}};

var Class = function (id) {
    return Resource.call(this, id, 'AWS::OpsWorks::Layer', {});
};
