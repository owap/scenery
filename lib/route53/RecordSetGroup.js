...
var RecordSet = require('../Route53/RecordSet.js');

var propertyMap = {'Comment': {'list': false, 'type': 'string'},
 'HostedZoneId': {'list': false, 'type': 'string'},
 'HostedZoneName': {'list': false, 'type': 'string'},
 'RecordSets': {'list': true, 'type': RecordSet}};

var Class = function (id) {
    return Resource.call(this, id, 'AWS::Route53::RecordSetGroup', {});
};
